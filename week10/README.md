...
A procedure to insert many new users from a list of names and phones - use a loop and IF inside the procedure, validate phone correctness, and return all incorrect data
